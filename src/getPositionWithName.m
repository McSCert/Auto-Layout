...
% GETPOSITIONWITHNAME finds the bounding box of a block accounting for
%   where its name appears if showing. Does not currently account for other
%   block parameters that might be showing.
%
%   Input:
%       block   A Simulink block.
%
%   Output:
%       bounds  Bounding box of the block. Returned in the same format as
%               the Position block parameter.
